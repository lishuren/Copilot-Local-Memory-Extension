...
- **Do not** fabricate or assume a successful log. Only report the result returned by the tool.
- **Do not** respond with a success message unless it is the exact string returned by the tool.
